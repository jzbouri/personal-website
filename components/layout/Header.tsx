...
import { FaGithub, FaLinkedin, FaStrava } from "react-icons/fa6";
...
export default function Header({ subtitle, links = [] }: HeaderProps) {
  ...
  return (
    <header className="relative mb-10 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] p-6">
