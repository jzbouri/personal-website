...
export default function ProjectCard({ item }: ProjectCardProps) {
  ...
  return (
    ...
    >
      <article className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] p-4 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.03] sm:p-5">
