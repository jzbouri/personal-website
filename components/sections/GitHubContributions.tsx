...
export default function GitHubContributions({ login }: { login: string }) {
  ...
  return (
    ...
    >
      <article className="relative overflow-hidden rounded-2xl border border-white/10 bg-[var(--surface-1)] p-4 sm:p-5 transition-all duration-300 hover:border-white/20 hover:bg-[var(--surface-2)] cursor-pointer">
